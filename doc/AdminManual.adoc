...
=== 6.1 Update Open Hospital - Database
...
[source,shell]
----
C:\WINDOWS\system32> cd C:\Users\OH\OpenHospital.1.12.1\sql

C:\Users\OH\OpenHospital.1.12.1\sql>
----
...
[source,shell]
----
C:\Users\OH\OpenHospital.1.12.1\sql> mysql –u root -p [-h hostname/ip address]
...
=== 6.2 Update Open Hospital - Client
...
=== 6.3 Update Open Hospital - Portable
