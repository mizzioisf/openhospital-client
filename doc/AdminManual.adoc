...
Configuration of the local Open Hospital instance (CLIENT and PORTABLE mode) is set in the configuration files called “properties files”. The following properties files are placed in the **oh/rsc** subfolder:
...
Use the provided startup scripts in order to automatically generate the _settings.properties_ file from the corresponding .dist files, or set manually the KEY/value pair as explained in the following sections.
...
Use the provided startup scripts in order to automatically generate the _database.properties_ file from the corresponding .dist files, or set manually the following parameters:
...
Use the provided startup scripts in order to automatically generate the _dicom.properties_ file from the corresponding .dist files, or set manually the following parameters:
...
Use the provided startup scripts in order to automatically generate the _log4j.properties_ file from the corresponding .dist files, or set manually the following parameters:
