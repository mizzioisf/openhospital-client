...
The default _settings.properties_ file is:
...
* *DBSERVER*: the IP address:TCP port/ Database name of the OH Database Server
IP address can be:
...
* *DBNAME*: the OH Database name
* *DBUSER*: the database user allowed to connect and operate on the database
