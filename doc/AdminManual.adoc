...
New releases, as well as this Manual and the User Manual, are regularly released on SourceForge/GitHub:

https://github.com/informatici/openhospital/releases
