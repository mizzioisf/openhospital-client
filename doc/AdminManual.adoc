...
* the *IP address* of the the MariaDB/MySQL Server database server hosting the the Open Hospital database. Replace “localhost” with the server IP address (e.g., 192.168.1.100)
* the *TCP Port Number* of the database server, if changed from the default “3306”
* the *Database name* - default is "oh"
* the *Database user* user (or the user specified in the installation phase) - default is "isf"
