...
The files can be modified using a text editor or through the configuration options available in the startup scripts **oh.sh / oh.ps1**.

NOTE: Any change to these files requires an application restart to apply the settings.

NOTE: Default properties files are distributed with a .dist extension
