...
The files can be modified using a text editor or through the configuration options available in the startup scripts **oh.sh / oh.ps1**, that can be used to generate the correct .properties files from the default distributed .properties.dist files.
