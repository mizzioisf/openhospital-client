...
on Windows:
----
C:\Users\OH\OpenHospital-v1.11.1
----
...
tar zxvf OpenHospital-v1.11.1-linux_[ARCH]-[portable].tgz # multiarch client version
----
on Windows:
----
unzip OpenHospital-v1.11.1-windows_[ARCH]-[portable].zip # portable version
unzio OpenHospital-v1.11.1-multiarch-client.zip à multiarch client version
----
