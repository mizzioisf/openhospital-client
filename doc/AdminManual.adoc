...
on Linux:
----
/usr/local/OpenHospital-[VERSION]
----
on Windows:
----
...
NOTE: Don not run OH by double-clicking on the oh.bat startup script without unzipping the package first!
...
* Create the OH database through the execution of a script placed in the _sql/_ folder
