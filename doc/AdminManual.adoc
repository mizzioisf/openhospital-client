...
The configuration files are related only to the local instance of Open Hospital; clients running Open Hospital may run differently according to their configuration files.
...
** org.isf.dicom.Sql*DicomManager: DICOM files are stored in the database
