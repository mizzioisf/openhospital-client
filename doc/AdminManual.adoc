...
on Linux: _/usr/local/OpenHospital_
on Windows: _C:\Users\OH\OpenHospital-v1.11.1_

To uncompress the package:

Portable version

* on Linux: _tar zxvf  OpenHospital-v1.11.1-linux_[ARCH]-[portable].tgz_ or _OpenHospital-v1.11.1-multiarch-client.zip_
