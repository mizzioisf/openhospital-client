...
unzip OpenHospital-v1.11.1-multiarch-client.zip à multiarch client version
----

After uncompressing the package, browse to the extracted directory:

----
cd /usr/local/OpenHospital-v1.11.1 # Linux
