#[width="99%",cols="^14%,^13%,^13%,^13,^13%,^13%,^13%,^12%,^12%,^12%",options="header"]
...
| 10.6.5 / n.a. |zulu11.60.19 |_Windows 10 2004_ (**) | i686 | 32bit |*v* |*v* |*v*
|10.5.18|zulu11.60.19|_Windows 7/10 (**)_ | _i386_ | _32bit_ |*v* |*v* |*v*
