...
function start_api {
	...
	Start-Process -FilePath "$JAVA_BIN" -ArgumentList $JAVA_ARGS -Wait -NoNewWindow -RedirectStandardOutput "$OH_DIR/$LOG_DIR/$API_LOG_FILE" -RedirectStandardError "$OH_DIR/$LOG_DIR/$API_ERR_LOG_FILE"
