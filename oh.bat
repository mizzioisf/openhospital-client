...
REM https://archive.mariadb.org/mariadb-10.6.28/winx64-packages/mariadb-10.6.28-winx64.zip
...
set MYSQL_DIR=mariadb-10.6.28-win%ARCH%
...
set JAVA_DIR=zulu17.68.203-ca-fx-jre17.0.20.1-win_%ARCH%
