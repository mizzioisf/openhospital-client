...
#^(LANGUAGE=)[a-zA-Z0-9]{2}$
		(Get-Content "$OH_PATH/$OH_DIR/rsc/settings.properties").replace('^(LANGUAGE=)[a-zA-Z0-9]{2}$',"LANGUAGE=$OH_LANGUAGE") | Set-Content "$OH_PATH/$OH_DIR/rsc/settings.properties"
	}
}
