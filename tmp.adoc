...
.2+|*OH version* .2+|Operating system .2+|O.S. Arch .2+|JAVA/JRE arch 3+|Note

.2+|*1.11.0* .2+| test .2+|*11.0.11*|multiarch | any | https://github.com/informatici/openhospital/releases/download/v1.10.0/OpenHospital-1.10.0.zip |*v* |*?* |*v*
